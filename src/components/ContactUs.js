...
const ContactUs = () => {
    ...
    return (
        <footer class="contact-us-footer" style={{position: "fixed", bottom: 0, left: 0, height: "30px", width: "100%", padding: "0.3rem", backgroundColor: "rgba(255, 255, 255, 0.5)", fontSize: "18px"}}>
